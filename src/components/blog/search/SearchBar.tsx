        ...
        <div className='my-8 rounded-lg border p-3 shadow-md sm:p-8'>
            <form className='group relative' onSubmit={handleSubmit}>
                <input
                    ...
                    className='z-20 w-full cursor-pointer rounded-full bg-gray-100 p-2 pl-9 text-sm text-gray-700 shadow-inner outline-none ring-1 ring-inset ring-gray-300 transition-all duration-200  placeholder:text-gray-400 hover:bg-gray-50 focus:bg-gray-50 focus:ring-2 focus:ring-inset focus:ring-red-600'
                ></input>
